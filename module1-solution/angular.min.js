...
(function(C) {
        ...
        this.$get = [
            ...
            function(a, b, c, e, p, M, L, u, R) {
                ...
                function oa(a, b) {
                    ...
                    if ('src' === b || 'ngSrc' === b)
                        return -1 === ['img', 'video', 'audio', 'source', 'track'].indexOf(a)
                            ? u.RESOURCE_URL
                            : u.MEDIA_URL;
                                ...
                                return {
                                    pre: function(a, c, f) {
                                        ...
                                        p &&
                                            ((f[e] = p(a)),
                                            ((c[e] || (c[e] = [])).$$inter = !0),
                                            ((f.$$observers && f.$$observers[e].$$scope) || a).$watch(p, function(
                                                a,
                                                b
                                            ) {
                ...
                c.onUrlChange(function(a, b) {
                    xc(a, r)
                        ? (d.$evalAsync(function() {
                              ...
                              m.absUrl() === a &&
                                  (f ? (m.$$parse(c), (m.$$state = e), h(c, !1, e)) : ((N = !1), l(c, e)));
                          }),
                          d.$$phase || d.$digest())
                        : (g.location.href = a);
                });
    ...
    q.prototype = {
        ...
        filter: function(a) {
            a = [a];
            for (
                var b = { type: q.CallExpression, callee: this.identifier(), arguments: a, filter: !0 };
                this.expect(':');
                        ...
                        p
                            ...
                            : (r(a.properties, function(b) {
                                  h.recurse(b.value, a.constant ? void 0 : h.nextId(), void 0, function(a) {
                                      l.push(
                                          h.escape(b.key.type === q.Identifier ? b.key.name : '' + b.key.value) +
                                              ':' +
                                              a
                                      );
                                  });
    ...
    var gh = {
            ...
            Z: function(a, b, d) {
                a = -1 * d;
                return (a =
                    (0 <= a ? '+' : '') + (Ob(Math[0 < a ? 'floor' : 'ceil'](a / 60), 2) + Ob(Math.abs(a % 60), 2)));
            },
            ww: Yd(2),
            w: Yd(1),
            G: Fc,
    ...
    var pe = {
            ...
            range: function(a, b, d, c, e, f) {
                ...
                function h(a) {
                    ...
                    X(c.$modelValue) ||
                        (m
                            ? ((a = b.val()), n < a && (b.val(n), (a = n < p ? p : n)), c.$setViewValue(a))
                            : c.$validate());
                }
                function l(a) {
                    s = na(a);
                    ...
                    link: {
                        ...
                        post: function(d, k, h, l) {
                            ...
                            d.$watchCollection(A.getWatchables, function() {
                                ...
                                q.$isEmpty(a) ||
                                    ((b = n.readValue()),
                                    (A.trackBy || z ? va(a, b) : a === b) || (q.$setViewValue(b), q.$render()));
                            });
                        }
                    }
                };
            ...
            function(a, b) {
                ...
                function c(a) {
                    k ||
                        ...
                        b.$$postDigest(function() {
                            b.$$destroyed ||
                                ((k = !1), e.ngModelCtrl.$setViewValue(e.readValue()), a && e.ngModelCtrl.$render());
                        }));
                }
                var e = this,
                    f = new Hb();
